...
// every 0.5 seconds, Runge-Kutta updates the rocket state.
...
TrajectoryResult simulate_trajectory(ControlProfile *control, int id)
{
    ...
    /* Track the best orbital insertion condition reached during flight.
 ...
 *
 * apply a very large flat penalty for not reaching orbit, and otherwise
